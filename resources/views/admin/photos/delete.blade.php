<div class="modal fade" id="photoConfirmDelete" tabindex="-1" role="dialog" aria-labelledby="photoConfirmDelete">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="photoConfirmDelete">Delete File</h4>
