    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="facilityModal">Add Facility Service</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            </div>
            <div class="modal-body">
                {!! Form::open(['method'=>'POST', 'action'=>'ServiceFacilityController@store', 'class'=>'', 'files'=>true]) !!}
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        {!! Form::select('cat_id', array(''=>'Choose Type') + $cat_facility, null, ['class'=>'form-control', 'id'=>'cat_id', 'required']) !!}
                    </div>
                    <div class="form-group col-md-6">
                        {!! Form::select('cat_id', array(''=>'Choose Type') + $cat_facility, null, ['class'=>'form-control', 'id'=>'cat_id', 'required']) !!}
                    </div>
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-success">Add Facility Service</button>
