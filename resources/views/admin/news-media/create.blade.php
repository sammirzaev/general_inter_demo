<div class="modal fade" id="newsMediaModal" tabindex="-1" role="dialog" aria-labelledby="newsMediaModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="newsMediaModal">Add News Media</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            </div>
            <div class="modal-body">
                {!! Form::open(['method'=>'POST', 'action'=>'NewsMediaController@store', 'class'=>'', 'files'=>true]) !!}
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        {!! Form::select('post_id', array(''=>'Choose Type') + $post, null, ['class'=>'form-control', 'id'=>'post_id', 'required']) !!}
                    </div>
                    <div class="form-group col-md-6">
                        {!! Form::select('post_id', array(''=>'Choose Type') + $post, null, ['class'=>'form-control', 'id'=>'post_id', 'required']) !!}
                    </div>
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-success">Add News Media</button>
