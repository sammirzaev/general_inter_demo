<div class="modal fade" id="navLogoModal" tabindex="-1" role="dialog" aria-labelledby="navLogoModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="navLogoModal">Add Nav Logo</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            </div>
            <div class="modal-body">
                {!! Form::open(['method'=>'POST', 'action'=>'NavLogoController@store', 'class'=>'', 'files'=>true]) !!}
                <div class="row">
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-success">Add Nav Logo</button>
