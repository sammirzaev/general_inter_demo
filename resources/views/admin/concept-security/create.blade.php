<div class="modal fade" id="securityConceptModal" tabindex="-1" role="dialog" aria-labelledby="securityConceptModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="securityConceptModal">Add Security Concept</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            </div>
            <div class="modal-body">
                {!! Form::open(['method'=>'POST', 'action'=>'ConceptSecurityController@store', 'class'=>'', 'files'=>true]) !!}
                <div class="row">
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-success">Add Security Concept</button>
