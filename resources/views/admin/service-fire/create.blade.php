<div class="modal fade" id="fireServiceModal" tabindex="-1" role="dialog" aria-labelledby="fireServiceModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="fireServiceModal">Add Fire Service</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            </div>
            <div class="modal-body">
                {!! Form::open(['method'=>'POST', 'action'=>'ServiceFireController@store', 'class'=>'', 'files'=>true]) !!}
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        {!! Form::select('type_id', array(''=>'Choose Type') + $type_fire, null, ['class'=>'form-control', 'id'=>'story_id', 'required']) !!}
                    </div>
                    <div class="form-group col-md-6">
                        {!! Form::select('type_id', array(''=>'Choose Type') + $type_fire, null, ['class'=>'form-control', 'id'=>'story_id', 'required']) !!}
                    </div>
                    <div class="form-group col-md-6">
                        {!! Form::select('cat_id', array(''=>'Choose Type') + $cat_fire, null, ['class'=>'form-control', 'id'=>'year', 'required']) !!}
                    </div>
                    <div class="form-group col-md-6">
                        {!! Form::select('cat_id', array(''=>'Choose Type') + $cat_fire, null, ['class'=>'form-control', 'id'=>'year', 'required']) !!}
                    </div>
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-success">Add Fire Service</button>
