<div class="modal fade" id="partnerModal" tabindex="-1" role="dialog" aria-labelledby="partnerModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="partnerModal">Add Home - Partners</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            </div>
            <div class="modal-body">
                {!! Form::open(['method'=>'POST', 'action'=>'HomePartnerController@store', 'class'=>'', 'files'=>true]) !!}
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        <label for="input-file-now">Logo Partner</label>
                        <div class="fallback">
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-success">Add Home Partner</button>
